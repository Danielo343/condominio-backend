        ...
        <body style="background-color: #0f172a; color: #f8fafc; font-family: Arial, sans-serif; padding: 40px; text-align: center;">
            <div style="max-width: 500px; margin: 0 auto; background-color: #1e293b; padding: 30px; border-radius: 16px; border: 1px solid #334155;">
                ...
                <p style="color: #cbd5e1; font-size: 14px; margin-bottom: 25px;">
                    Has solicitado restablecer tu contraseña. Utiliza el siguiente código de 6 dígitos para completar el proceso:
                </p>
                ...
                <p style="color: #64748b; font-size: 12px; margin-bottom: 0;">
                    Este código caducará en 15 minutos. Si no solicitaste este restablecimiento, puedes ignorar este mensaje de manera segura.
                </p>
            </div>
        </body>
        </html>';

        return $this->subject('Código de Recuperación de Contraseña - CondoMaster Pro')
                    ->html($htmlContent);
    }
}